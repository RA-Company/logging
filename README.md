...
## Used libraries
* gopkg.in/Graylog2/go-gelf.v2/gelf -- GELF Library and Writer for Go (MIT License)
* github.com/google/uuid -- Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. (BSD-3 License)
* github.com/stretchr/testify - Thou Shalt Write Tests (MIT License)
